...
angular.module('page', ['ideUI', 'ideView', 'entityApi'])
	...
	.config(['entityApiProvider', function (entityApiProvider) {
		entityApiProvider.baseUrl = '/services/js/codbex-accounts/gen/codbex-accounts/ui/launchpad/Home/tiles.js';
	}])
	.controller('PageController', ['$scope', 'messageHub', 'entityApi', '$document', function ($scope, messageHub, entityApi, $document) {
		const favoritesStoreId = 'DIRIGIBLE.codbex-accounts.favorites';
		$scope.state = {
			isBusy: true,
			error: false,
			busyText: 'Loading...',
